...
function injectApprovalList (requestView, requiredApprovals, approvalUsers) {
  ...
  approvalUsers.forEach(entry => {
    listContainer += `<div class='link-to-member-avatar'>
      <a class="author_link has-tooltip approver-avatar js-approver-list-member" data-container="body" href="/${entry.user.username}" data-original-title="Approved by ${entry.user.name}">
